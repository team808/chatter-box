    ...
    switch(parsedMessage.command) {
      ...
      case 'dm':
        chatRoom.getClient(parsedMessage.args)
          .write(JSON.stringify(parsedMessage));
        break;
      ...
      case 'yesterday':
        chatRoom.getYesterday()
          .then(messages => {
            ...
            messages.forEach(parsedMessage => connectedClient.write((JSON.stringify(parsedMessage))));
            connectedClient.write((JSON.stringify(parsedMessage)));
            // connectedClient.write('$$$');
          });
        break;
